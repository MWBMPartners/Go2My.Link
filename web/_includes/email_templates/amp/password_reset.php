...
/**
 * ============================================================================
 * ⚡ Go2My.Link — AMP Email Template: Password Reset
 * ============================================================================
 *
 * AMP4Email variant of the password reset template. Sent when a user requests
 * a password reset via the forgot-password page. Includes CTA button, fallback
 * link, and 1-hour expiry notice.
 *
