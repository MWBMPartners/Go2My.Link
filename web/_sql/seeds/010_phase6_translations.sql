...
('en-GB', 'analytics.export_csv', 'Export CSV', 'Analytics dashboard', 1),
...
('en-GB', 'analytics.stat_bot_clicks', 'Bot Clicks', 'Analytics dashboard', 1),
('en-GB', 'analytics.stat_human_clicks', 'Human Clicks', 'Analytics dashboard', 1),
('en-GB', 'analytics.stat_total_clicks', 'Total Clicks', 'Analytics dashboard', 1),
('en-GB', 'analytics.stat_unique_ips', 'Unique Visitors', 'Analytics dashboard', 1),
