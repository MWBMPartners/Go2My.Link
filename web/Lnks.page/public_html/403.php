...
/**
 * ============================================================================
 * 🔒 Go2My.Link — LinksPage 403 Forbidden (Component C)
 * ============================================================================
 *
 ...
 * Directories" rules in .htaccess). Self-contained — no external CDN
 * scripts/stylesheets — so it renders correctly under this component's strict
 * Content-Security-Policy (script-src 'self'; no inline scripts at all).
 *
...
<body>
    <main class="lp-error-container">
        <p class="lp-error-code" aria-hidden="true">403</p>
