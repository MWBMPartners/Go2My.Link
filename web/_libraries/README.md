...
| ⚙️ Bootstrap JS (Bundle) | 5.3.3 | jsdelivr.net | `bootstrap/js/bootstrap.bundle.min.js` | UI components (includes Popper) |
...
| --- | --- | --- |
| 🗺️ Leaflet.js | 6 | Geographic maps for analytics |
