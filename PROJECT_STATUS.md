...
> **[.claude/HANDOFF.md](.claude/HANDOFF.md)** (live pick-up point) and
...
> "Blockers: None" below is also stale — see `.claude/HANDOFF.md`'s owner-action list (credential
...
credentials. See `.claude/HANDOFF.md`.)_
